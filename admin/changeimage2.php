...
if(isset($_POST['update'])){
	...
	$sql="update camera set image2='$image2' where id_camera='$id'";
...
<head>
	...
	<title>Rental camera | Admin Update Image 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gambar camera 2</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Gambar camera 2 Details</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">

											<div class="form-group">
											<label class="col-sm-4 control-label">Gambar camera 2 Sekarang</label>
												<?php 
												$id=intval($_GET['imgid']);
												$sql ="SELECT image2 from camera where id_camera='$id'";
												$query	= mysqli_query($koneksidb, $sql);
												$cnt=1;
