...
<head>
	...
	<title>Rental Camera | Admin Edit Sewa Camera</title>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=$_GET['id'];
										$sqlsewa = "SELECT booking.*,camera.*,merek.*,users.* FROM booking,camera,merek,users WHERE booking.id_camera=camera.id_camera
													AND merek.id_merek=camera.id_merek AND users.email=booking.email AND booking.kode_booking ='$id'";
										$querysewa = mysqli_query($koneksidb,$sqlsewa);
										$result = mysqli_fetch_array($querysewa);
										$biayacamera=$result['durasi']*$result['harga'];
										$total = $result['driver']+$biayacamera;
										?>
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="namacamera" class="form-control" value="<?php echo $result['nama_camera'];?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
												<label class="col-sm-2 control-label">Biaya Pengantaran</label>
												<div class="col-sm-4">
											...
											<br/>
											<div class="form-group">
												<label class="col-sm-2 control-label">Biaya Camera</label>
												<div class="col-sm-4">
													<input type="text" name="biayacamera" class="form-control" value="<?php echo format_rupiah($biayacamera);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
