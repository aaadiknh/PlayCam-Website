...
if($_GET) {
	...
	$sqlsewa = "SELECT booking.*,camera.*,merek.*,users.* FROM booking,camera,merek,users WHERE booking.id_camera=camera.id_camera
				AND merek.id_merek=camera.id_merek AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<table width="100%">
	...
	<tr>
		...
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_merek'];?>, <?php echo $result['nama_camera'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	...
	<tr>
		<td width="20%"><b>Biaya Camera</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $biayacamera;?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
