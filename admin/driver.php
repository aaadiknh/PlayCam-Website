...
<head>
	...
	<title>Rental Camera | Admin Update Info</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Update Biaya Pengantaran</h2>
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Form Update Biaya Pengantaran</div>
							  ...
							  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								{?>	
									<div class="form-group">
										<label class="col-sm-4 control-label"> Biaya Pengantaran </label>
											<div class="col-sm-8">
