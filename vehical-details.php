...
$sql = "SELECT camera.*, merek.* from camera, merek WHERE merek.id_merek=camera.id_merek AND camera.id_camera='$vhid'";
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo htmlentities($result['nama_merek']);?>, <?php echo htmlentities($result['nama_camera']);?></h2>
      </div>
      <div class="col-md-3">
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Deskripisi Camera</a></li>
