...
$sql1 	= "SELECT booking.*,camera.*, merek.*, users.* FROM booking,camera,merek,users WHERE booking.id_camera=camera.id_camera 
			AND merek.id_merek=camera.id_merek and booking.email=users.email and booking.email='$email'";
...
<center><h3>Riwayat Sewa</h3></center>
	...
	<thead>
		<tr>    
			...
			<th width="132">Nama Camera</th>
			<th width="80">Tgl. Mulai</th>
			<th width="100">Tgl. Selesai</th>
			<th width="50">Durasi</th>
			<th width="100">Biaya Camera</th>
			<th width="110">Biaya Pengiriman</th>
	...
	if(mysqli_num_rows($query1)!=0){
		...
		?>
			<tr>
				...
				<td><?php echo $result['nama_camera']; ?></td>
