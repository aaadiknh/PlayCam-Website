...
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,camera.*, merek.*, users.* FROM booking,camera,merek,users WHERE booking.id_camera=camera.id_camera 
			AND merek.id_merek=camera.id_merek and booking.email=users.email and booking.kode_booking='$kode'";
...
<head>
	...
	<meta name="description" content="rental camera">
	<meta name="author" content="universitas pamulang">

	<title>Cetak Detail Sewa PlayCam</title>
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Rental Camera</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					
					<tr>
						<td class="text-center">Jl. Pringgodani No.17, Jurug, Ngringo, Kec. Jaten, Kabupaten Karanganyar, Jawa Tengah 57731 </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Camera</td>
						<td>:</td>
						<td><?php echo $result['nama_merek'];echo  ", "; echo $result['nama_camera']; ?></td>
					</tr>
					<tr>
						<td>Tanggal Mulai</td>
						<td>:</td>
					...
					<tr>
						<td>Biaya Camera (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
						<td><?php echo format_rupiah($totalcamera);?></td>
					</tr>
					<tr>
